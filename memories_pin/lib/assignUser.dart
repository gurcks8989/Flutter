...
import 'package:memories_pin/userElement.dart';
...
class EditStatusMessage extends StatelessWidget {
  const EditStatusMessage({required this.state, required this.statusMessage, required this.onEdit,
    // required this.editStatusMessage,
    required this.statusMessageController, required this.scrollController});
  final bool state;
